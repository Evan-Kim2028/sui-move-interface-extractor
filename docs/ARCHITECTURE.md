...
**A2A Protocol Guide:** This implementation is fully compliant with Google's A2A Protocol v0.3.0. See **[A2A Protocol](A2A_PROTOCOL.md)** for detailed compliance, examples, and tuning guidance.
...
Path: `docs/schemas/evaluation_bundle.schema.json`
...
See **[Benchmark Guide](BENCHMARK_GUIDE.md)** for usage examples and **[A2A Protocol](A2A_PROTOCOL.md)** for integration details.
