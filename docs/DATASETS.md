...
- **[Benchmark Guide](BENCHMARK_GUIDE.md)** - Benchmark usage guide.
- **[Architecture](ARCHITECTURE.md)** - Code architecture.
- **[Testing](TESTING.md)** - Testing standards.
- **[Methodology](METHODOLOGY.md)** - Scoring and extraction logic.
